...
<?php if(have_posts()): while(have_posts()): the_post(); ?>
    <main class="layout__singleDispositif">
        ...
        <div class="singleDispositif__content reveal">
            ...
            <div class="single__technicals reveal">
            ...
            <div class="single__results reveal">
            ...
            <div class="single__price reveal">
        ...
        <aside class="singleDispositif__aside reveal">
